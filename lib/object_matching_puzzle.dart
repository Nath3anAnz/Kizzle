...
class _ObjectMatchingPuzzleState extends State<ObjectMatchingPuzzle>
  ...
  void _setupLevel() {
    ...
    if (widget.level == '1' || widget.level.toLowerCase() == 'easy') {
      ...
      targetMatchedImagePath =
          "assets/images/matchshapelvl1/matchkakisepatu.png";
      ...
      wrongs = [
        {
          "name": "Topi",
          "imagePath": "assets/images/matchshapelvl1/matchtopi.png",
        },
        {
          "name": "Sarung Tangan",
          "imagePath": "assets/images/matchshapelvl1/matchsarung.png",
        },
      ];
      ...
      options.add({
        "name": wrongs[0]["name"],
        "imagePath": wrongs[0]["imagePath"],
      });
      options.add({
        "name": wrongs[1]["name"],
        "imagePath": wrongs[1]["imagePath"],
      });
      ...
      targetName = "Es Krim";
      targetImagePath =
          "assets/images/matchshapelvl3/object_matching_level2_es_krim.png";
      targetMatchedImagePath =
          "assets/images/matchshapelvl3/object_matching_level2_sukses.png";

      correctOption = "Cone";
      String correctImagePath =
          "assets/images/matchshapelvl3/object_matching_level2_cone.png";
      ...
      wrongs = [
        {
          "name": "Piring",
          "imagePath":
              "assets/images/matchshapelvl3/object_matching_level2_piring.png",
        },
        {
          "name": "Kaos Kaki",
          "imagePath":
              "assets/images/matchshapelvl3/object_matching_level2_kaos_kaki.png",
        },
      ];
      ...
      targetName = "Mobil";
      targetImagePath =
          "assets/images/matchshapelvl2/object_matching_level3_mobil.png";
      targetMatchedImagePath =
          "assets/images/matchshapelvl2/object_matching_level3_sukses.png";

      correctOption = "Jalan";
      String correctImagePath =
          "assets/images/matchshapelvl2/object_matching_level3_jalan.png";
      ...
      wrongs = [
        {
          "name": "Laut",
          "imagePath":
              "assets/images/matchshapelvl2/object_matching_level3_laut.png",
        },
        {
          "name": "Langit",
          "imagePath":
              "assets/images/matchshapelvl2/object_matching_level3_langit.png",
        },
      ];
  ...
  void _playIntroTts() async {
    try {
      await AudioManager().playVoice(_ttsPlayer, ttsFileName, stopFirst: true);
    } catch (e) {
  ...
  void _checkAnswer(String droppedName) {
    if (droppedName == correctOption) {
      ...
      _timer?.cancel();
      _ttsPlayer.stop();
      AudioManager().cancelVoiceDucking(_ttsPlayer);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Object Matching - Level ${widget.level}",
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: options.map((opt) {
                            ...
                            if (opt.containsKey("imagePath") &&
                                opt["imagePath"] != null) {
                              optionDisplay = Image.asset(
                                opt["imagePath"],
                                width: 60,
                                height: 60,
                                fit: BoxFit.contain,
