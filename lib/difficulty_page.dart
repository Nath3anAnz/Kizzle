...
class DifficultyPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Select Difficulty", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => LeaderboardPage(kategori: kategori)),
              );
            },
          ),
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(
                    ...
                    color: Colors.white,
                    shadows: [BoxShadow(color: Colors.black45, blurRadius: 5, offset: Offset(2, 2))]
                  ),
                ),
  ...
  Widget _buildDiffButton(BuildContext context, String title, Color color, String levelStr, int filledStars) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => CountdownPage(kategori: kategori, level: levelStr)),
          );
        },
        child: Container(
