                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Center(
                          child: Icon(Icons.bar_chart, size: 100, color: Colors.orange),
                        ),
                      ),
                      ...
                      Row(
                        ...
                        children: List.generate(
                          3,
                          (index) => Icon(
                            index < _stars ? Icons.star : Icons.star_border, // Pakai variabel _stars
                            color: Colors.amber, 
                            size: 55,
                          ),
                        ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: ActionButton(
                              ...
                              onPressed: () {
                                Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => CountdownPage(kategori: 'Size Sorting', level: widget.level)));
                              },
                            ),
                          ),
                          Expanded(
                            child: ActionButton(
                              ...
                              onPressed: () {
                                ...
                                if (nextLevelInt > 3 || widget.level.toLowerCase() == 'hard') {
                                  ...
                                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => CountdownPage(kategori: 'Size Sorting', level: nextLevelInt.toString())));
                                }
                              },
                            ),
                          ),
